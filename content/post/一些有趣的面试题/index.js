...
function people(name) {
    ...
    function sleeping(n) {
        return new Promise(function (_) { return setTimeout(_, n); });
    }
    var methods = {
        eat: function (food) {
            function newTask(preTask) {
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, preTask];
                            case 1:
                                _a.sent();
